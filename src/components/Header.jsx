  ...
  return (
    <div className='h-25 flex justify-between items-center pl-12 pr-12 py-3'>
        ...
        <div className='flex items-center gap-4'>
            ...
            <div className='bg-[#243056] p-2.5 pr-5 pl-5 rounded-full text-[#5981F3] font-bold transition-all duration-300 hover:cursor-pointer hover:text-[#3b4874]'>Connect</div>
        </div>
